...
using NewShore.Api.Client.Contracts;
...
namespace NewShore.Api.Client
{
    ...
    public partial class FlightsClient : BaseClient, IFlightsClient
    {
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public FlightsClient(IOptions<NewShoreConfiguration> configuration, System.Net.Http.HttpClient httpClient) : base(configuration)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.IList<Journey>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new FlightsApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
                        ...
                        if (status_ == 404)
                        {
                            ...
                            throw new FlightsApiException<ErrorModel>("A server side error occurred.", status_, objectResponse_.Text, headers_, objectResponse_.Object, null);
                        }
                        else
                        if (status_ == 500)
                        {
                        ...
                        else
                        {
                            ...
                            throw new FlightsApiException("The HTTP status code of the response was not expected (" + status_ + ").", status_, responseData_, headers_, null);
                        }
                    }
                    finally
                    {
        ...
        protected virtual async System.Threading.Tasks.Task<ObjectResponseResult<T>> ReadObjectResponseAsync<T>(System.Net.Http.HttpResponseMessage response, System.Collections.Generic.IReadOnlyDictionary<string, System.Collections.Generic.IEnumerable<string>> headers, System.Threading.CancellationToken cancellationToken)
        {
            ...
            if (ReadResponseAsString)
            {
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    throw new FlightsApiException(message, (int)response.StatusCode, responseText, headers, exception);
                }
            }
            else
            {
                ...
                catch (Newtonsoft.Json.JsonException exception)
                {
                    ...
                    throw new FlightsApiException(message, (int)response.StatusCode, string.Empty, headers, exception);
                }
            }
        }
